...
class ICollectionFilterBaseSchema(Interface):
    ...
    target_collection = schema.Choice(
        ...
        description=_(
            ...
            default=u"As an alternative you can select a different collection as source for the filter items "
            u"and where the filter is applied. If not given, we use the current context as collection.",
        ),
        required=False,
