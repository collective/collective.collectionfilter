...
Scenario: Add filter before content listing
    # Verifies that a warning appears when filter tiles are present but no Content Listing tile,
    # and that the warning disappears once a Content Listing tile is added.
