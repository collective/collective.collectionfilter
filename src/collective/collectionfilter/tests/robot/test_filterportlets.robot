...
Scenario: Path Filter with links
    Given I've got a site with a collection
     ...
     When I'm viewing the collection
     Then Should be filter links  All (6)  Test Folder2 (1)  Test Folder (2)
...
Scenario: Path Filter with Dropdown
    Given I've got a site with a collection
     ...
     When I'm viewing the collection
      and Should be filter options  All (6)  Test Folder2 (1)  Test Folder (2)  
...
Scenario: Path Filter with Checkboxes
    Given I've got a site with a collection
     ...
     When I'm viewing the collection
     Then Should be filter checkboxes  All (6)  Test Folder2 (1)  Test Folder (2) 
