...
[![CI](https://github.com/collective/collective.collectionfilter/actions/workflows/main.yml/badge.svg)](https://github.com/collective/collective.collectionfilter/actions/workflows/main.yml)
...
- **Collection Maps** — a [LeafletJS](https://leafletjs.com/) map which shows and filters `IGeolocatable` items on it
...
- **Collection Result Listing Sort** — a list of indexes where the user can sort the filtered result listing
- **Collection Filter Reset** — a link to reset all filters
...
If `collective.geolocationbehavior` is installed, this package provides a [LeafletJS](https://leafletjs.com/) Maps tile/portlet
...
If your theme doesn't work well with `AJAX` loading this can be overridden in the registry or via [diazo](https://docs.diazo.org/en/latest/index.html).
...
This package is based on [collective.portlet.collectionfilter](https://pypi.org/project/collective.portlet.collectionfilter/) and [collective.portlet.collectionbysubject](https://pypi.org/project/collective.portlet.collectionbysubject/).
